...
import axios from 'axios'; // 用于加载GeoJSON数据

export default {
    name: 'MapChart',
    data() {
        return {
            mapDataUrl: 'https://raw.githubusercontent.com/echarts-maps/echarts-countries-js/master/geojson/hubei.geo.json', // GeoJSON 文件的 URL
            chartInstance: null,
            geohubei: {
                            ...
                            coordinates: [
                                [
                                    [
                                        ...
                                        [112.597581, 30.515152],
                                        [112.58422, 30.526997],
                                        [112.57917, 30.521994],
                                        [112.57917, 30.509722],
                                        [112.572257, 30.510278],
                                        [112.568217, 30.494881],
                            ...
                            coordinates: [
                                [
                                    [
                                        ...
                                        [113.462582, 30.406263],
                                        [113.464369, 30.42193],
                                        [113.461417, 30.430148],
                                        ...
                                        [114.095776, 31.573833],
                                        [114.094456, 31.578908],
                                        [114.10168, 31.592185],
                                        [114.097485, 31.603473],
                                        [114.109215, 31.605756],
                                        [114.108982, 31.620973],
                            ...
                            coordinates: [
                                [
                                    [
                                        ...
                                        [114.072316, 31.78491],
                                        [114.08661, 31.782209],
                                        [114.089872, 31.794867],
                                        [114.099194, 31.803388],
                                        [114.118149, 31.805708]
                                    ]
                                ],
                                [
                ...
                date: '2024/11/27 15:34:43',
                copyright: 'Copyright (c) 2024 GeoJSON.CN',
    ...
    methods: {
        ...
        initChart() {
            ...
            echarts.registerMap('USA', this.geohubei);

            // echarts.registerMap('湖北', this.geohubei);
            // 设置图表配置项
            this.chartInstance.setOption(barOption);
            // let mapOption = this.getChartOption();
            let that = this;
            ...
            setInterval(function () {
                ...
                that.chartInstance.setOption(currentOption, true);
            }, 2000);
        },
